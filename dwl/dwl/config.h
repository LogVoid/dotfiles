...
static const char *const autostart[] = {
        "swaybg", "-i", "/home/logvoid/Pictures/wallpaper.png", NULL,
        "waybar", NULL,
        NULL /* terminate */
};
...
static const char *launcherPrompt[] = { "wofi", "--show", "drun", NULL };
static const char *internetBrowser[] = {"firefox", NULL};
static const char *fileExplorer[] = {"thunar", NULL};

static const Key keys[] = {
	/* Note that Shift changes certain key codes: c -> C, 2 -> at, etc. */
	/* modifier                  key                 function        argument */
	{ MODKEY,                    XKB_KEY_p,          spawn,          {.v = launcherPrompt} },
	{ MODKEY,                    XKB_KEY_Return,     spawn,          {.v = terminal} },
  { MODKEY,                    XKB_KEY_f,          spawn,          {.v = internetBrowser} },
  { MODKEY,                    XKB_KEY_n,          spawn,          {.v = fileExplorer} },
